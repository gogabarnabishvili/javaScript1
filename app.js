...
// ეს სერჩამდე გავაკეთე იყოს ბარემ 
...
if ((start <= num4) && (num4 <= end)) {
    console.log("bettween the range")
} else {
...
if (operator == "add") {
    console.log(num1 + num2, "Print result of num1+num2")
} else if (operator == "subtract") {
    console.log(num1 - num2, "Print result of num1-num2")
} else if (operator == "multiplay") {
    console.log(num1 * num2, "Print result of num1*num2")
    ...
    console.log(operator, "Invalid operation")
}
// exe 8 
const year = 2024;
